  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border bg-background border-main-border font-semibold hover:text-hover-text hover:border-hover-border',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'hover:text-hover-text font-semibold',
        link: 'text-primary underline-offset-4 hover:underline',
        active: 'bg-light-green text-text-button'
      },
      size: {
        ghost: 'w-min h-min leading-none',
        active: 'p-[15px] rounded-xl',
