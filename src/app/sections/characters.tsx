...
import { Card, CardContent, CardHeaderWood, CardImageWood, CardText } from './components/card'

export const Characters = () => {
    return (
        <div className="flex flex-col items-center gap-14 mb-[250px]">
            <H2Gradient>{CHARACTERS_DATA.title}</H2Gradient>
            <div className="flex justify-between xl:w-[1280px]">
